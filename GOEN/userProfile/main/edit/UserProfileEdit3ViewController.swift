//
//  UserProfileEdit3ViewController.swift
//  GOEN
//
...
class UserProfileEdit3ViewController: UIViewController {

    @IBOutlet weak var university_name: UITextField!
    @IBOutlet weak var university_subject: UITextField!
    ...
    override func viewDidLoad() {
        ...
        self.university_name.text = work_university_name
        self.university_subject.text = work_university_subject
    ...
    @IBAction func updateProfile3(_ sender: Any) {
        ...
        self.api.updateProfile3(id: work_id, university_name: self.university_name.text!, university_subject: self.university_subject.text!)
    }
