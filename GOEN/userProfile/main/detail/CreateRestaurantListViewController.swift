...
class CreateRestaurantListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    let cellId = "createRestaurantCell"
    
    override func viewWillAppear(_ animated: Bool) {
        print("restaurant appear!")
        ...
        tableView.register(CreateRestaurantCell.self, forCellReuseIdentifier: self.cellId)
    ...
    @objc func clickAddButton(_ sender: AnyObject) {
        ...
        let viewCtl = CreateRestaurantViewController()
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return self.api.user_restaurant_list.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: self.cellId, for: indexPath) as! CreateRestaurantCell
        print("aaaaaaaa")
        cell.res = self.api.user_restaurant_list[indexPath.row]
    ...
    @objc func del(_ sender: UIButton) {
        ...
        let cell = sender.superview as! CreateRestaurantCell
        let row = self.tableView.indexPath(for: cell)?.row
        
        self.api.delUserHoby(id: self.api.user_restaurant_list[row!].id!)
    }
