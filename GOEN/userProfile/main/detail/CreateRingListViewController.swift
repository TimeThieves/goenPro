//
//  CreateRingViewController.swift
//  GOEN
//
...
class CreateRingListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        tableView.register(CreateRingCell.self, forCellReuseIdentifier: self.cellId)
    ...
    @objc func clickAddButton(_ sender: AnyObject) {
        print("add ring")
        let viewCtl = CreateRingViewController()
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return self.api.user_ring_list.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: self.cellId, for: indexPath) as! CreateRingCell
        print("aaaaaaaa")
        cell.ring = self.api.user_ring_list[indexPath.row]
    ...
    @objc func del(_ sender: UIButton) {
        ...
        let cell = sender.superview as! CreateRingCell
        let row = self.tableView.indexPath(for: cell)?.row
        
        self.api.delUserHoby(id: self.api.user_ring_list[row!].id!)
    }
...
class CreateRingCell: UITableViewCell {
