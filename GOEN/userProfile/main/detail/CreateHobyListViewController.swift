//
//  CreateHobyViewController.swift
//  GOEN
//
...
class CreateHobyListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        tableView.register(CreateHobyCell.self, forCellReuseIdentifier: self.cellId)
    ...
    @objc func clickAddButton(_ sender: AnyObject) {
        print("add book")
        let viewCtl = CreateHobyViewController()
    ...
    @objc func del(_ sender: UIButton) {
        ...
        let cell = sender.superview as! CreateHobyCell
        let row = self.tableView.indexPath(for: cell)?.row
        
        self.api.delUserHoby(id: self.api.user_hoby_list[row!].id!)
    }
    
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return self.api.user_hoby_list.count
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: self.cellId, for: indexPath) as! CreateHobyCell
        print("aaaaaaaa")
        cell.hoby = self.api.user_hoby_list[indexPath.row]
...
class CreateHobyCell: UITableViewCell {
