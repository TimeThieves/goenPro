...
class CreateBookViewController: UIViewController, UITextViewDelegate {
    ...
    let NAME_TEXT: String = "好きな本を入力してください。"
    ...
    override func viewDidLoad() {
        ...
        navItem = UINavigationItem(title: "好きな本の追加")
    ...
    @objc func add() {
        ...
        loadDataObserver = NotificationCenter.default.addObserver(
            ...
            using: {
                ...
                if self.api.errFlg {
                    ...
                    let alert = UIAlertController(title:"追加完了", message: "あなたの好きな本を追加しました。", preferredStyle: UIAlertControllerStyle.alert)
                    let action1 = UIAlertAction(title: "閉じる", style: UIAlertActionStyle.default, handler: {
                        (action: UIAlertAction!) in
        ...
        self.api.setUserBook(name: name.text!)
    }
