...
class CreateFoodViewController: UIViewController, UITextViewDelegate {
    ...
    let NAME_TEXT: String = "好きな食べ物を入力してください。"
    ...
    override func viewDidLoad() {
        ...
        navItem = UINavigationItem(title: "好きな食べ物の追加")
    ...
    @objc func add() {
        ...
        self.api.setUserFood(name: name.text!)
    }
