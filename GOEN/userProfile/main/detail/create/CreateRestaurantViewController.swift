...
class CreateRestaurantViewController: UIViewController,UITextViewDelegate {
    ...
    let NAME_TEXT: String = "おすすめレストランを入力してください。"
    ...
    override func viewDidLoad() {
        ...
        navItem = UINavigationItem(title: "おすすめレストランの追加")
    ...
    @objc func add() {
        ...
        loadDataObserver = NotificationCenter.default.addObserver(
            ...
            using: {
                ...
                if self.api.errFlg {
                    ...
                    let alert = UIAlertController(title:"追加完了", message: "あなたのおすすめレストランを追加しました。", preferredStyle: UIAlertControllerStyle.alert)
                    let action1 = UIAlertAction(title: "閉じる", style: UIAlertActionStyle.default, handler: {
                        (action: UIAlertAction!) in
        ...
        self.api.setUserRestaurant(name: name.text!)
    }
