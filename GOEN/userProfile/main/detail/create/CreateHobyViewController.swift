...
class CreateHobyViewController: UIViewController, UITextViewDelegate {
    ...
    let NAME_TEXT: String = "趣味を入力してください。"
    ...
    override func viewDidLoad() {
        ...
        navItem = UINavigationItem(title: "趣味の追加")
    ...
    @objc func add() {
        ...
        self.api.setUserHoby(name: name.text!)
    }
