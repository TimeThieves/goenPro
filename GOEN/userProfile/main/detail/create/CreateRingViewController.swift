...
class CreateRingViewController: UIViewController,UITextViewDelegate {
    ...
    let NAME_TEXT: String = "指輪の情報を入力してください。"
    ...
    override func viewDidLoad() {
        ...
        navItem = UINavigationItem(title: "指輪情報の追加")
    ...
    @objc func add() {
        ...
        self.api.setUserRing(name: name.text!)
    }
