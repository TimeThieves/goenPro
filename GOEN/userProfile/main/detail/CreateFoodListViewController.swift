...
class CreateFoodListViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        tableView.register(CreateFoodCell.self, forCellReuseIdentifier: self.cellId)
    ...
    @objc func clickAddButton(_ sender: AnyObject) {
        print("add food")
        let viewCtl = CreateFoodViewController()
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return self.api.user_food_list.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: self.cellId, for: indexPath) as! CreateFoodCell
        print("aaaaaaaa")
        cell.food = self.api.user_food_list[indexPath.row]
    ...
    @objc func del(_ sender: UIButton) {
        ...
        let cell = sender.superview as! CreateFoodCell
        let row = self.tableView.indexPath(for: cell)?.row
        
        self.api.delUserFood(id: self.api.user_food_list[row!].id!)
    }
...
class CreateFoodCell: UITableViewCell {
